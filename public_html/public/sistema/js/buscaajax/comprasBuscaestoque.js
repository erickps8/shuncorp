...
function MostraOpcao(str,v2,v3){
	if (str.length==0){
...
if (xmlHttp.readyState==4)
{
	...
	e.innerHTML='<a href="#" onclick="deleteRow(this.parentNode.parentNode.rowIndex,'+texto[0]+')"><img src="http://www.ztlbrasil.com.br/public/images/window-close.png" width="15" heigth="15" border="0" title="Remover"></a>';
