...
function gravarDadosnfevenda(){	
    ...
    $.post('/admin/venda/pedidosentdadosajax', {ped: $("input[name=ped]").val(), pedcli: $("input[name=pedcli]").val(), placa: $("input[name=placa]").val(), frete: $("input[name=frete]").val(), seguro: $("input[name=seguro]").val(), desconto: $("input[name=desconto]").val(), descontoperc: $("input[name=descontoperc]").val(), prazo1: $("input[name=prazo1]").val(), vlprazo1: $("input[name=vlprazo1]").val(), dataprazo1: $("input[name=dataprazo1]").val(), prazo2: $("input[name=prazo2]").val(), vlprazo2: $("input[name=vlprazo2]").val(), dataprazo2: $("input[name=dataprazo2]").val(), prazo3: $("input[name=prazo3]").val(), vlprazo3: $("input[name=vlprazo3]").val(), dataprazo3: $("input[name=dataprazo3]").val(), prazo4: $("input[name=prazo4]").val(), vlprazo4: $("input[name=vlprazo4]").val(), dataprazo4: $("input[name=dataprazo4]").val(), prazo5: $("input[name=prazo5]").val(), vlprazo5: $("input[name=vlprazo5]").val(), dataprazo5: $("input[name=dataprazo5]").val(), qtpacote: $("input[name=qtpacote]").val(), especie: $("#especie option:selected").text(), tipofrete: $("#tipofrete option:selected").val(), pesobruto: $("input[name=pesobruto]").val(), antt: $("input[name=antt]").val(), ufplaca: $("#ufplaca option:selected").text(), obs: $("#obs").val(), obsnfe: $("#obsnfe").val(), email: $("input[name=email]").val(), contatoemail: $("input[name=contatoemail]").val(), totalnota: $("input[name=totalnota]").val()}, 
    function(resposta) {
        if (resposta != false) {
...
function gerarNfevenda(str){	
	...
	var url="/admin/venda/pedidosentdadosajax/gerarvenda/true/ped/"+str;
